...
public class CuentaCorriente {
    ...
    /**
     * Al saldo actual de la cuenta le añade el importe. Cada tres ingresos suma un bonus de 0.7
    ...
    /**
     * Retira dinero de la cuenta corriente restándoselo al parámetro saldo. Se comprueba que hay saldo suficiente antes
     * de la retirada, en caso contrario el resultado sería false y no se haría ninguna operación. Además se le suma una
     * comisión a la retirada que no será nunca inferior al mínimo establecido.
     * @param importe cantidad de dinero que se quiere retirar de la cuenta.
     * @return  Devuelve true si se ha retirado el dinero y false en caso contrario al no haber suficiente saldo.
     */
